...
impl WindowManager {
    ...
    pub fn background_webview_attached(
        ...
        self.platform.background_webview_attached(window_id, owner)
    }
    ...
    pub fn navigate_background_webview(
        ...
        self.platform
            .navigate_background_webview(window_id, owner, url)
    }
    ...
    pub fn eval_background_webview_js(
        ...
        self.platform
            .eval_background_webview_js(window_id, owner, js, callback)
    }
    ...
    pub fn snapshot_background_webview(
        ...
        self.platform
            .snapshot_background_webview(window_id, owner, callback)
    }
    ...
    pub fn set_background_webview_interactive(
        ...
        self.platform
            .set_background_webview_interactive(window_id, owner, interactive)
    }
    ...
    pub fn set_background_webview_visible(
        ...
        self.platform
            .set_background_webview_visible(window_id, owner, visible)
    }

    pub fn detach_background_webview(
        &self,
        window_id: WindowId,
        owner: &crate::platform::BrowserUnderlayOwner,
    ) {
        self.platform.detach_background_webview(window_id, owner)
    }
